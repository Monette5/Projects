...
app.get('/settings', checkInstance, function(req, res) {
  ...
  // Get settings from the S3 bucket
	...
	/****TRIAL EXTEBD CODE HERE ***************************/
	 if(req.instanceId=='2f5f4237-09fd-4cfc-aca7-ad7d1317e83c' || req.instanceId=='6c5f2868-7b32-4737-818d-6f46d324ce34' || req.instanceId=='6ee84d0f-6aab-4906-821e-f6f2c05e303d' || req.instanceId=='f22b689d-e313-4767-b4f3-4bae613cb990'){
		settings.trial_expires = '2019-08-30T00:00:00.000Z';
     }
	 /********************/
	
	if(req.instanceId=='f60c6480-2a8a-45d1-bcf4-a9618e6cbfa5'){
		//settings.trial_expires = '2018-05-24T00:00:00.000Z';
		settings.trial_expires = '2019-05-24T00:00:00.000Z';
     }
	
	trial_expires: "2018-05-24T00:00:00.000Z"
