...
ripples.init("js-ripple-btn", 0.85);
// ripples.init("js-ripple-btn2", 1.25);can be initialised seprarately if needed
// ripples.init("js-ripple-btn3", 1.25);
// ripples.init("js-ripple-btn4", 1.25);
