...
/******Cooltips Options Save */
    ...
    if(localSettings.transitiontype=="distortion"){
        ...
        localSettings.linkFont          = $('#text-font-link').getCtrl().getValue().font;
        localSettings.linkFontcolor     = hexToRgb($('#text-font-link').getCtrl().getValue().color.color);
    }
...
//console.log("Dd"+settings.transitiontype);
//console.log("ddddddreterteretd");
   ...
   /****One Time Animation*****/
	...
	var designOpts = ['images_filter_option','trigger_icon_option','videoAccordion','trans_color_link','cooltips_color_link','particles_color_link','borderandline1','font-option'];
    for (key in designOpts) {
        $('#' + designOpts[key]).addClass('display-none');
    }
    ...
    if (transition_type == 'codyhouse' || transition_type == 'codyhouse2' || transition_type == 'codyhouse3' || transition_type == 'codyhouse4' || transition_type == 'codyhouse5' || transition_type == 'codyhouse6') {
        ...
        $("#textbtn-font-off").val('Start Button');


        $('#images_filter_option').removeClass('display-none');
        $('#videoAccordion').removeClass('display-none');
        $('#trans_color_link').removeClass('display-none');
     ...
     /****Classic Pack */
        ...
        $('#textbtn-font-off').show();
		$('#mobile-text-level').show();
		$('#mobilebuttonsize').show();
     ...
     /****Atomic Pack */
        ...
        var hideparticlesId =  ['color-filterlevel-end','image-zoom-on','color-filter-label','text-animation-delay-on','mobile-text-level','mobilebuttonsize','trans_color_link','image-zoom-off','image-zoom-on','text-animation-off','text-animation-on','borderandline1','videoAccordion','trigger_icon_option','mobileparagraphsize','mobilefontsize','textbtn-allowlink',
     ...
     /****Cooltips Pack */
        ...
        $('#trigger_icon_option').removeClass('display-none');
        $('#cooltips_color_link').removeClass('display-none');
        $('#font-option').removeClass('display-none');
    ...
    /****Particles Pack */
        ...
        'text-animation-delay-off','start_end_toggle_level','start_textsection_label','resetbtn_start','layoutsettings',
        'textbtn-allowlink-container','text-align-off','start_text_label','choose_effect_container','settings_trigger_level','text-animation-off'];
        for (key in hideparticlesId) {
            $('#' + hideparticlesId[key]).hide();
        }
        $('.images_filter').hide();
     ...
     /****Distortion Pack */
        ...
        $("#images_filter_option").text('Images');
    ...
    var effectTypeImg = ['cooltips','distortion','tilter'];
    var effectTypeZoomArr  = ['ap1','distortion','tilter'];


     if (settings.image0[0] == undefined) {
        if($.inArray(settings.transitiontype, effectTypeImg )=== -1){
