/* eslint-disable */
        ...
        renderParticles: function () {
            ...
            for (var i = 0; i < this.particles.length; i++) {
                ...
                if (p.life < p.death) {
                    ...
                    var particlescolor = "#3333FF";
                    if(settings.particlescolorfilter!=undefined){
                        particlescolor = settings.particlescolorfilter;
                    }

                    //this.ctx.fillStyle = this.ctx.strokeStyle = p.color;
                   this.ctx.fillStyle = particlescolor;
                    this.ctx.beginPath();
    ...
    function getCSSValue(el, prop) {
		var e1 = document.querySelectorAll('.particles');
		if(e1!=undefined){
	...
	const particle = $.makeArray(document.querySelectorAll('.particles'));
    var transformString = (getCSSValue(document.querySelectorAll('.particles'), t) ? t : '-webkit-' + t);
