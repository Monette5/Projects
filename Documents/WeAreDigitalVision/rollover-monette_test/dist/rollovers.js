 ...
 *   on_load - Provides an opportunity to do any DOM manipulation/preperation for the effect
...
/***             'codyhouse3': {
    ...
    /*****Particle Buttons *****/
            ...
            'theme-1': {
                id: 'theme-1',
                name: 'Theme-1',
                menus: ['peranent-effect', 'imageOff', '_text-align-on', 'text-on', 'text-font-on', 'text-colour-on', 'background-colour-on',
                 'link-tab', 'link', 'textbtn-tab', 'textbtn-tablink', 'textbtn-off', 'textbtn-on', 'subtext-off', 'trancolor', 'colorfilter-on',
                 'subtext-font-off', 'subtext-colour-off', 'overlay-on', 'overlay-off', 'subtext-off', 'subtext-font-off', 'subtext-colour-off'
                ],
                on_load: function(data) {
