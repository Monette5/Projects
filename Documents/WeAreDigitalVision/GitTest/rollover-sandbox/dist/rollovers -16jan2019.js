     ...
     'codyhouse': {
        ...
        /****Not working particle color */
         ...
         'distortion-1': {
             id: 'distortion-1',
             name: 'Jumping Around',
             menus: ['text-align-off','text-align-on','heading-off', 'subheading-off','start-tab', 'imageOff', 'imageOn', 'link-tab', 'link', 'text-font-heading', 'text-colour-heading', 'text-font-subheading', 'text-colour-subheading'],
             on_load: function(data) {
        ...
        'distortion-4': {
            id: 'distortion-4',
            name: 'Water Wonders',
            menus: ['heading-off', 'subheading-off','start-tab', 'imageOff', 'imageOn', 'link-tab', 'link', 'text-font-heading', 'text-colour-heading', 'text-font-subheading', 'text-colour-subheading'],
            on_load: function(data) {
                default_distortion_on_load(data);
            },
            animation_script_on: function(data) {
