 ...
 */
{
	...
	const tooltips = $.makeArray(document.querySelectorAll('.tooltip'));
	...
	class Tooltip {
		constructor(el) {
			...
			if( this.DOM.shape ) {
				this.DOM.path = this.DOM.shape.childElementCount > 1 ? $.makeArray(this.DOM.shape.querySelectorAll('path')) : this.DOM.shape.querySelector('path');
			}
