...
public class Dialog extends JPanel {
    ...
    public Dialog(JFrame frame) {
       ...
       // JPanel frequentPanel = createSimpleDialogBox();
        JPanel difficultyPanel = createFeatureDialogBox();
        JPanel picturePanel = createIconDialogBox();
        ...
        difficultyPanel.setBorder(padding);
        picturePanel.setBorder(padding);

        JTabbedPane tabbedPane = new JTabbedPane();
//        tabbedPane.addTab("Simple Modal Dialogs", null,
//                          frequentPanel,
//                          simpleDialogDesc); //tooltip text
        tabbedPane.addTab("Select Difficulty", null,
                          difficultyPanel,
                          moreDialogDesc); //tooltip text
        tabbedPane.addTab("Select new Picture", null,
                          picturePanel,
    ...
    protected static ImageIcon createImageIcon(String path) {
        java.net.URL imgURL = Dialog.class.getResource(path);
        if (imgURL != null) {
...
//    }
    ...
    private JPanel createIconDialogBox() {
        ...
        final String easyString = "Easy";
    final String normalString = "Normal";
    final String hardString = "Hard";
      

        radioButtons[0] = new JRadioButton("Plain (no icon)");
        radioButtons[0].setActionCommand(easyString);

        radioButtons[1] = new JRadioButton("Information icon");
        radioButtons[1].setActionCommand(normalString);

        radioButtons[2] = new JRadioButton("Question icon");
        radioButtons[2].setActionCommand(hardString);
        ...
        showItButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                //no icon
                if (command == easyString) {
                    JOptionPane.showMessageDialog(frame,
                                    "Eggs aren't supposed to be green.",
                                    "A plain message",
                                    JOptionPane.PLAIN_MESSAGE);
                //information icon
                } else if (command == normalString) {
                    JOptionPane.showMessageDialog(frame,
                                    "Eggs aren't supposed to be green.",
        ...
        showItButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (command == pickOneCommand) {
                    Object[] possibilities = {"Same Picture", "New Picture"};
