...
function encodeSettings() {
   ...
   // console.log( $('#cooltipanimation').getCtrl().getValue());
...
function reflectSettings() {
   /*** var rollover;
    ...
    var menus = ['peranent-effect', 'opacity', 'blur', 'zoom', 'twist', 'direction',
        ...
        'cooltip_text_label','cooltipscolor-opacity','cooltips-imgfilter-label'
    ...
    if (transition_type == 'codyhouse' || transition_type == 'codyhouse2' || transition_type == 'codyhouse3' || transition_type == 'codyhouse4' || transition_type == 'codyhouse5' || transition_type == 'codyhouse6') {
       ...
       // show_button_link(textbtnb, false);
        ...
        [
            ...
            'start_text_label','text-align-off','mobilefontsize','mobile-text-level','textbtn-allow',
            'textbtn-allowlink','end_text_label','start-end-toggle','start_end_toggle_level','settings_trigger_level',
            'start-end-toggle2','design_start_end'
        ];
        ...
        $("#cooltipscolor-opacity").show();
        $("#start_tab_text_section").show();
        $("#cooltips-imgfilter-label").show();
    }
