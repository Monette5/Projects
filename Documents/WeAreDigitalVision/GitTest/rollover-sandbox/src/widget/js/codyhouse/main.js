jQuery(document).ready(function ($) {
   ...
   // Preview Mode ( distortion effect code Start 
    var transition = "";
	var effectCount = 2;
	$( "#distortion" ).mouseleave(function(){setTimeout(function(){ effectCount =1; },950);});
	$( "#distortion" ).mouseover(function()
	{
		if(settings.sticky == true)
		{
			...
			console.log(effectCount);
				if(effectCount == 2)
				{
					$('#distortion div.grid__item div.grid__item-img canvas').show();
				...
				if(effectCount == 1)
				{
					...
					$('#distortion .grid__item-img  div.dist_editor_img').css('background-image', 'url("' + image0Src + '")');
					$('#distortion .grid__item-img canvas').css('height','auto');
					$('#distortion div.grid__item div.grid__item-img canvas').hide();
				}
	...
	// Preview Mode ( distortion effect code END 			

    // Preview Mode Function ( distortion effect code Start 
	...
	//Preview Mode Function (distortion effect code) END 
